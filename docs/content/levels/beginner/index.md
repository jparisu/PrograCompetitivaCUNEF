# Contenidos · Principiante

Técnicas, algoritmos y estructuras de nivel **Principiante**. Primeras técnicas de concurso. Familiarízate con la programación competitiva y los conceptos básicos de algoritmos y estructuras de datos.
...
<div class="ov-wrap" markdown="0">
  ...
  <div id="overview-table" class="ov-table-container" data-level="beginner">
