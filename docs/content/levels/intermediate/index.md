# Contenidos · Intermedio

Técnicas, algoritmos y estructuras de nivel **Intermedio**. Estructuras de datos más complejas, grafos y algoritmos específicos para problemas tipo.
...
<div class="ov-wrap" markdown="0">
  ...
  <div id="overview-table" class="ov-table-container" data-level="intermediate">
