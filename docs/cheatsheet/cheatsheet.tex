...
cin.tie(nullptr);
// Then read/print as usual:  cin >> x;   cout << x << '\n';
...
\csalgo{MiniMax}
\csstats{time: O(n), space: O(n)  |  Encontrar el mejor movimiento en un juego de dos jugadores.}
\begin{lstlisting}[language=C++]
#include <vector>
#include <functional>
#include <limits>
