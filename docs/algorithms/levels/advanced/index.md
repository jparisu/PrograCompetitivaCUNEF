...
Técnicas, algoritmos y estructuras de nivel **Avanzado**. Técnicas potentes para problemas difíciles. Usa el menú lateral para abrir cada uno.
...
<div class="ov-wrap" markdown="0">
  ...
  <div id="overview-table" class="ov-table-container" data-level="advanced">
